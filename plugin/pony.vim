...
function! s:Completion(ArgLead, CmdLine, CursorPos)
  ...
  elseif match(a:CmdLine, 'Dsettings') >= 0
    let s:filename = 'settings.py'
  endif
...
command! -nargs=? -complete=customlist,s:Completion Dsettings :call s:DjangoGoto('<args>', 'settings')
command! -nargs=+ -bar Dmanage :call s:DjangoManage('<args>')

" @bernd switching between controller, model and view
nnoremap ,m :Dmodels<CR> 
nnoremap ,v :Dviews<CR> 
nnoremap ,a :Dadmin<CR> 
nnoremap ,t :DTests<CR> 
nnoremap ,u :Durls<CR> 
nnoremap ,s :Dsettings<CR> 
