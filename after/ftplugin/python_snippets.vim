...
" Class definition.
exec "Snippet class class ".st."ClassName".et."(".st."object".et."):
\<CR>\"\"\"
\<CR>".st.et."
\<CR>\"\"\"
\<CR>
...
" short list
exec "Snippet list [e * 2 for e in list]".st.et
...
" Shebang
exec "Snippet sb #!/usr/bin/env python<CR># -*- coding: UTF-8 -*-<CR>".st.et
...
if getline(1) =~ 'from django.db import models'
    ...
    function! SelectModel()
        ...
        let et = g:snip_end_tag
        let cd = g:snip_elem_delim
        let mt = inputlist(['Select modeltype:',
                    \ '1. CharField',
                    \ '2. SlugField',
                    \ '3. BooleanField'])
        let dts = {1: "models.CharField(max_length=".st."50".et.st.et.")".st.et,
                 \ 2: "models.SlugField(".st.et.")".st.et,
                 \ 3: "models.BooleanField()".st.et}
        
        return dts[mt]
    endfunction
    exec "Snippet mod ``SelectModel()``"
